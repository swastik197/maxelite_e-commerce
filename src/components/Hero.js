...
const Hero = () => {
  ...
  return (
    <>
      {/* ═══ Hero Banner Section ══════════════════════════════════ */}
      <section ref={bannerRef} className='lg:h-screen bg-[#001D39] p-3 py-6 sm:p-4 lg:p-6 lg:py-10 flex flex-col gap-3 sm:gap-4'>
        <div className='w-full flex-1 grid sm:grid-cols-3 grid-cols-1 gap-3 sm:gap-4 min-h-0'>
          ...
          <div
            ...
            className={`col-span-1 sm:col-span-2 bg-cover bg-center rounded-2xl flex items-center justify-center relative overflow-hidden min-h-[200px] sm:min-h-0 transition-all duration-1000 ease-out ${
              bannerVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 -translate-x-10 scale-[0.97]'
            }`}
          >
          ...
          <div
            ...
            className={`bg-cover bg-center rounded-2xl flex items-center justify-center relative overflow-hidden min-h-[160px] sm:min-h-0 transition-all duration-1000 ease-out delay-300 ${
              bannerVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-10 scale-[0.97]'
            }`}
          >
            <div className='absolute inset-0 bg-black/40'></div>
        ...
        <div ref={promoRef} className='hidden md:grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4'>
          <div className={`bg-gradient-to-r from-amber-400 to-orange-400 rounded-2xl flex items-center justify-between px-5 sm:px-8 py-5 sm:py-6 overflow-hidden group hover:shadow-xl hover:shadow-amber-500/20 transition-all duration-500 cursor-pointer ${
            promoVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          ...
          <div className={`bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-between px-5 sm:px-8 py-5 sm:py-6 overflow-hidden group hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-500 cursor-pointer ${
            promoVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
      ...
      <section ref={carouselRef} className='my-0.5 relative py-8 bg-[#001D39] overflow-hidden'>
        <h2 className={`text-2xl font-bold text-white mx-10 mb-6 transition-all duration-700 ${carouselVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
          Featured Products
          {/* Animated underline */}
        ...
        <button
          onClick={scrollLeft}
          className='absolute left-0 top-1/2 mx-4 -translate-y-1/2 z-10 bg-white/90 hover:bg-white p-3 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 active:scale-95'
        >
        ...
        >
          {featuredProducts.map((product, i) => (
            <Link
              ...
              className={`md:min-w-[260px] min-w-[200px] z-20 bg-white rounded-xl shadow-md overflow-hidden group hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-3 transition-all duration-500 ${
                carouselVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95'
              }`}
            >
              ...
              <div className='p-4'>
                ...
                <h3 className='font-semibold text-gray-800 truncate text-sm mb-2 group-hover:text-purple-700 transition-colors duration-300'>{product.name}</h3>
        ...
        <button
          onClick={scrollRight}
          className='absolute right-0 top-1/2 mx-4 -translate-y-1/2 z-10 bg-white/90 hover:bg-white p-3 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 active:scale-95'
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* ═══ Category Showcase ═════════════════════════════════════ */}
      <section ref={categoryRef} className='my-0.5 bg-[#001D39] p-4'>
          ...
          {promotionalCategories.map((category, index) => {
            ...
            return (
              <Link
                ...
                className={`h-52 rounded-xl relative overflow-hidden group bg-cover bg-center ${category.image ? '' : `bg-gradient-to-br ${bgColors[index]}`} transition-all duration-700 ease-out hover:shadow-2xl hover:shadow-purple-500/15 hover:-translate-y-2 ${
                  categoryVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'
                }`}
              >
      ...
      <section ref={ctaRef} className='mx-4 my-8'>
        <div className={`bg-gradient-to-r from-purple-700 via-purple-600 to-pink-500 rounded-xl p-8 md:p-12 text-white text-center relative overflow-hidden transition-all duration-1000 ease-out ${
          ctaVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-[0.97]'
        }`}>
