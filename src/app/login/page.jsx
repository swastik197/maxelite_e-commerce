...
const AuthPage = () => {
  ...
  return (
    <div className='h-3/4  flex overflow-hidden shadow-2xl'>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center p-12 bg-gray-50'>
        <div className='w-full max-w-sm'>
          ...
          <div className='lg:hidden text-center mb-6'>
            <span className='text-2xl font-bold text-purple-600'>MaxElite</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            {!isLogin && (
              <label className='flex items-center gap-2 text-xs text-gray-500'>
                ...
                I agree to the <Link href='/terms' className='text-purple-600 hover:underline'>Terms</Link> & <Link href='/privacy' className='text-purple-600 hover:underline'>Privacy</Link>
              </label>
            )}
          ...
          <div className='flex gap-4'>
            <button className='flex-1 flex items-center justify-center gap-2 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition text-sm'>
          ...
          {/* Back to Home */}
          <Link href='/' className='block text-center mt-6 text-xs text-gray-400 hover:text-purple-600 transition'>
            ← Back to shopping
          </Link>
        </div>
      </div>
